  ...
  return (
    <PageSection width="narrow" padding="large" animate={true}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-neutral-darkest">
          {title}
        </h1>
        <p className="text-xl font-medium leading-relaxed text-neutral-darkest mb-6">
          {description}
        </p>
