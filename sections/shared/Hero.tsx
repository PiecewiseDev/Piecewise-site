        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="flex justify-center items-center">
            <Link
              ...
              prefetch={true}
              className="group bg-blue-600 text-white hover:text-gray-100 rounded-lg px-5 sm:px-7 py-2.5 sm:py-3.5 shadow-lg hover:bg-blue-700 hover:scale-105 hover:shadow-xl inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 active:bg-blue-800 active:shadow-sm active:translate-y-0.5 gap-2 text-sm sm:text-base"
            >
