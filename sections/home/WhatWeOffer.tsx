...
const WhatWeOffer: React.FC = () => {
  ...
  return (
    <div
      className="bg-section-dark py-16 md:py-24 shadow-[0_-8px_32px_rgba(0,0,0,0.15),0_8px_32px_rgba(0,0,0,0.15)]"
      ref={containerRef}
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-20 text-section-light">
            What We Offer
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          {offerings.map((offering, index) => (
            <div
              key={index}
              className={`md:col-span-4 relative rounded-3xl p-8 transition-all duration-1000 border border-white/10 ${
            ...
            >
              ...
              <div className="space-y-6 pt-4">
                <h3 className="text-lg md:text-xl font-bold text-left text-section-light">
                  {offering.title}
                </h3>

                <p className="text-base leading-relaxed text-left text-section-light opacity-90">
                  ...
                  <ul className="space-y-3 pt-2">
                    {offering.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start">
                        ...
                        ></span>
                        <span className="text-sm text-section-light opacity-80">{feature}</span>
                      </li>
                    ))}
                  </ul>
                </div>
