      ...
      <div className="w-full mx-auto px-4 sm:px-6 md:px-14 lg:px-24 xl:px-28 2xl:px-32 pt-28 sm:pt-32 md:pt-36 lg:pt-40 xl:pt-44 2xl:pt-48 pb-6 sm:pb-7 md:pb-8 lg:pb-9 xl:pb-10 2xl:pb-12">
        ...
        <div>
          <h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl font-bold text-gray-900 leading-[1.08] tracking-tight mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-center lg:text-left"
          >
            Let&apos;s Work Together
          </h1>
