...
const ContactDetails: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-card p-6">
        <h2 className="text-xl mb-4">Business Hours</h2>
      ...
      <div className="bg-white rounded-lg shadow-card p-6">
        ...
        <div className="flex space-x-4">
          <a
            href="#"
            className="h-10 w-10 rounded-full bg-accent flex items-center justify-center text-white"
          >
